	...
	<div data-pageid='main'>
		...
		<table cellspacing="0" cellpadding="0" class='toolbox' id='toolbox'><tr valign="top">
			<td class='toolbox-left'>
				...
				<div id='toolboxExpandDiv' style='padding-right:0px;'>				
					<img id='toolboxExpandIcon' src=''/>
					<img id='toolboxExpandPlusIcon' src='' style='margin-left:4px; margin-right:4px;'/>
					<input type='text' value='1' min='1' max='100' required id='toolboxExpandInput' class='small'/>
					<img id='toolboxExpandMinusIcon' src='' style='margin-left:4px; margin-right:4px;'/>
				</div>			
				<div id='toolboxExpandAllDiv' style='cursor:pointer;'>
					<img id='toolboxExpandAllIcon' src='' />
				</div>
			</td>
		</tr></table>
	</div>
